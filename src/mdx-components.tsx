...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    h1: (props) => (
      <h1 className="font-bold text-4xl md:text-5xl mt-2xl mb-xl text-text-primary" {...props} />
    ),
    h2: (props) => (
      <h2 className="font-bold text-2xl md:text-3xl mt-xl mb-lg text-text-primary" {...props} />
    ),
    h3: (props) => (
      <h3 className="font-semibold text-xl md:text-2xl mt-lg mb-md text-text-primary" {...props} />
    ),
    h4: (props) => (
      <h4 className="font-semibold text-lg md:text-xl mt-lg mb-md text-text-primary" {...props} />
    ),
    h5: (props) => (
      <h5 className="font-semibold text-base md:text-lg mt-lg mb-md text-text-primary" {...props} />
    ),
    h6: (props) => (
      <h6 className="font-semibold text-sm md:text-base mt-lg mb-md text-text-primary" {...props} />
    ),
    hr: (props) => <hr className="my-xl" {...props} />,
    ...
    img: (props) => (
      <figure>
        ...
        />
        {props.alt && (
          <figcaption className="mt-sm text-center text-secondary italic">{props.alt}</figcaption>
        )}
      </figure>
    ),
    a: (props) => (
