...
export default function Header() {
  ...
  return (
    <header className="flex justify-center py-3 px-8 w-full h-16 bg-bg-primary sm:bg-transparent sm:bg-gradient-to-b sm:from-background-primary sm:from-40% sm:to-transparent">
